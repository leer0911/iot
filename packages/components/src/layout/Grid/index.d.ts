...
export interface GridProps extends StandardProps<React.HTMLAttributes<HTMLElement> & Partial<Record<Breakpoint, boolean | GridSize>>, GridClassKey> {
  as?: string | React.ComponentType<Omit<GridProps, StrippedProps>>;
  container?: boolean;
  item?: boolean;
